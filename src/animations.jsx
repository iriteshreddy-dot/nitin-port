...
function PlaybackBar({ time, duration, playing, onPlayPause, onReset, onSeek, onHover }) {
  ...
  return (
    <div style={{
      ...
      padding: '8px 16px', background: 'rgba(20,20,20,0.92)',
      ...
      <div
        ref={trackRef}
        onMouseMove={onTrackMove} onMouseLeave={onTrackLeave} onMouseDown={onTrackDown}
...
// ── Exports ───────────────────────────────────────────────────────────────────
export { Easing, interpolate, animate, clamp };
export { TimelineContext, useTime, useTimeline };
export { Sprite, SpriteContext, useSprite };
export { TextSprite, ImageSprite, RectSprite };
export { Stage, PlaybackBar, IconButton };

// keep window globals for standalone HTML usage
